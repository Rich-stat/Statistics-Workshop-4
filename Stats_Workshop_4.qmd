...
`titanConTab |>`<br> `cramer_v()`<br> <br> 
Cramer's V ranges from 0 (no association between factors) to 1 (complete association). The tab below shows how to interpret the Cramer's V value obtained.<br>
