...
![Uploading a file to RStudio](upload gof.png){.lightbox width="70%"}
...
![Uploading a file to RStudio](upload titanic.png){.lightbox width="70%"}
...
![Uploading a file to RStudio](upload mcnemar.png){.lightbox width="70%"}
